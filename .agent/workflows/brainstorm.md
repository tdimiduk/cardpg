...
- **System Prompt**:
  ...
  - Anchor consequences in realistic biology, physics, or historical verisimilitude, adding "Research Notes" (either citing existing design/research reports or pointing out areas for future research).
  - Strictly avoid proposing specific card rules, card types, deck pollution math, or in-game statistics.
  - Save brainstormed content into files under `design/research/synthesis/` (e.g., `design/research/synthesis/consequence-database.md`).
  ...
  | Consequence Name              | Tags              | Sensory / Narrative Description                                                      | Immediate Impact (1-100) | Recovery Difficulty (1-100) | Realistic Healing / Clearing Process                                      | Verisimilitude & Research Notes                                                        | Citations                                                                                                                        |
  | :---------------------------- | :---------------- | :----------------------------------------------------------------------------------- | :----------------------: | :-------------------------: | :------------------------------------------------------------------------ | :------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------- |
  | **Example: Stance Disrupted** | Physical, Balance | Sudden shift of weight, arms flailing to recover center of gravity.                  |            5             |              3              | Catching balance, centering center of mass (seconds).                     | Loss of balance recovery requires active stabilization of core muscles.                | [report-dynamics-of-duel](file:///home/tdimiduk/cardpg/cardpg/design/research/reports/dynamics-of-the-duel/report.md)            |
  | **Example: Ruptured Tendon**  | Physical, Legs    | A sharp, sickening pop in the back of the heel followed by a hot, tearing sensation. |            45            |             75              | Surgical repair, leg immobility (3-6 months), extensive physical therapy. | Tendons have poor blood supply, slowing healing. Rupture causes loss of joint flexion. | [report-battlefield-injury](file:///home/tdimiduk/cardpg/cardpg/design/research/reports/pre-modern_battlefield_injury/report.md) |
  ```
