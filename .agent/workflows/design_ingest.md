...
2.  **Review and Refine**
    Use the _Code Persona_ or _Artificer Persona_ to validate the imported text against the current rules.
    _(e.g., "Review this proposal for conflicts with core-rules.md")_
