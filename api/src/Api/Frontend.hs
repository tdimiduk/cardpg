...
import Core.Card qualified as Core
import Core.Json (cardpgJsonDef, cardpgJsonOptions, cardpgTaggedOptions)
import Core.Logic.Combat (computeDefense, computeDefenseDetails, computeResilience)
import Core.NonEmptyText (NonEmptyText)
import Core.Primitives (CardInstanceId, CardLocation, ChallengeId)
...
import Core.RuleDefs qualified as Core
import Core.State
  ( AssetState
  , CorePlayState
  , RevealedEffect
