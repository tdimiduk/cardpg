...
header :: Text
header =
  "/* This file is auto-generated by client/app/GenCss.hs */\n/* Run 'cabal run gen-css' to update */\n"
...
main = do
  ...
  filesRoot <- findHaskellFiles "client/src"
  ...
  T.writeFile "client/static/atomic.css" (header <> renderAll unique)
  putStrLn $ "Done. Wrote client/static/atomic.css with " <> show (length unique) <> " rules."
