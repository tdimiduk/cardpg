...
Each attacker allocates their individual Impact across any combination of severities they can afford (e.g., an attacker who generated 4 Impact may choose to draw a single Severity 4 card, two Severity 2 cards, or one Severity 3 and one Severity 1 card).
