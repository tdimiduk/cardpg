...
| Report                                                                                                     | Summary                                                                                                                                                          |
| :--------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Pre-Modern Battlefield Injury](reports/pre-modern_battlefield_injury/report.md)                           | A detailed analysis of pre-modern battlefield trauma, its functional impacts, and progression. Used for designing injury, death, and healing mechanics.          |
| [Functional Decline Under Physical Hardship](reports/functional-decline-under-physical-hardship/report.md) | A scientific analysis of how real-world injuries and hardship affect the human body, providing a factual basis for the game's consequence and harm mechanics.    |
...
| [Dynamics of the Duel](reports/dynamics-of-the-duel/report.md)                                             | A detailed biomechanical and tactical analysis of pre-modern combat, focusing on physiological energy systems, fatigue, and the rhythm of a one-on-one engage... |
...
| [Combat Locomotion](reports/combat-locomotion/report.md)                                                   | A detailed biomechanical analysis of pre-modern combat locomotion.                                                                                               |
| [Combat Action Time](reports/combat-action-time/report.md)                                                 | A quantitative lexicon of the time costs, in seconds, for discrete pre-modern combat actions, including ranged attacks, movement, and weapon handling.           |
...
| [Exertion Recovery Dynamics](reports/exertion-recovery-dynamics/report.md)                                 | A quantitative analysis of the physiological dynamics of exertion, stress, and multi-stage recovery.                                                             |
...
| [Armor Effectiveness](reports/armor_effectiveness/report.md)                                               | Research on armor effectiveness against different damage types.                                                                                                  |
