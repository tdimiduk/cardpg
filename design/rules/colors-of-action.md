...
- `Red`
  ...
  - Lead a Ferocious Charge: Lead a chaotic, aggressive charge focused on breaking enemy morale with pure ferocity.
  - Make a Last Stand: Fight desperately against hopeless odds to create a diversion or buy time.
  - Passionate Surge: Channel your fervent belief or raw rage to temporarily ignore the penalties from wounds or fatigue.
...
- `Yellow`
  ...
  - Dirty Trick: Employ a feint, thrown pocket-sand, or other underhanded tactic to make an opponent vulnerable for a follow-up attack.
...
- `Blue`
  ...
  - Defensive Stance: Adopt a disciplined posture that improves your ability to defend but restricts your movement or offensive options for a round.
  - Exploit a Weakness: Use knowledge of a creature's vulnerability to your advantage in a fight.
...
- `Red`
  ...
  - Endure the Elements: Resist the effects of harsh environmental conditions like extreme heat or cold.
...
- `Yellow`
  ...
  - Maneuver and Pursue: Pilot a nimble vehicle, conduct a hit-and-run attack, or relentlessly track a foe across a great distance.
  - Move Unseen: Move silently to avoid patrols or use natural camouflage to hide from a searching enemy.
...
- `Blue`
  ...
  - Observe and Plan: Methodically case a location to learn its routines and defenses.
  - Painstaking Search: Perform a slow, methodical, and exhaustive search of a small area to find clues that a quicker or less disciplined search would miss.
  - Read the Scars: Methodically "read" the history of a location by observing its architecture, state of decay, and environmental clues to uncover its original purpose or learn of a past tragedy.
  - Remote Sensing: Project your consciousness into an animal to scout or spy from a distance.
  - Methodically case a location to learn it’s routine and defenses
...
- `Red`
  ...
  - Build a reputation
  - Demand Trial by Combat: Formally resolve a legal dispute through a sanctioned, often lethal, duel.
  - Hold Court: Use your sheer force of personality to command the attention of an entire room, setting the agenda and forcing others to react to you.
  - Issue a Challenge: Publicly challenge a rival to a non-lethal contest of skill to prove a point or humiliate them.
  - Make a moving Oration, Musical or theatrical performance
...
- `Yellow`
  ...
  - Create a Distraction: Creating a minor diversion to draw attention away from an ally.
  - Find a Contact: Actively search for a specific type of person by navigating the social landscape of a settlement.
  - Gather Information: Discreetly gather rumors, tail a suspect, or manage a network of spies.
  - Goad into Action: Using carefully chosen insults or provocations to trick someone into a foolish mistake.
  - Impersonate and Infiltrate: Use a disguise, magical or mundane, to get close to a target.
  - Lip-Read: Reading lips from a distance to gather information.
  - Navigate a Social Event: Gracefully move through a complex social gathering, making all the right pleasantries to achieve a specific goal without causing offense.
  - Perform Sleight of Hand: Use misdirection and manual dexterity to cheat at games, pick a pocket, or swap an item unseen.
...
- `Blue`
  ...
  - Maintain Composure: Use intense self-control to maintain a "poker face" while under interrogation, enduring magical compulsion, or telling a high-stakes lie.
  - Manipulate Your Rivals: Play factions against one another through a long-term strategy of rumor and betrayal to advance your own goals.
  - Master a Persona: Create and maintain a convincing false identity to infiltrate an organization.
  - Observe and Plan: Perform a "cold read" of a person to deduce their secrets.
  - Orchestrate a Scheme: Take the first step in a long-term plot, setting up the pieces that will be knocked down later to gain leverage or manipulate a rival.
  - Present a Formal Argument: Engage in a structured debate, using rhetoric and evidence to systematically dismantle an opponent's position.
  - Recall and Recite: Remember a key piece of lore, a specific law, or a family's history to solve a problem or win an argument.
...
- `Red`
  ...
  - Labor: Perform strenuous manual labor such as mining, chopping wood, or smithing.
  - Manage Holdings: Oversee the administration of your land, fortress, or business, dealing with logistics and personnel.
  - Provide for the Group: Go hunting or perform focused labor specifically to contribute to the well-being and resources of your party.
...
- `Yellow`
  ...
  - Craft Intricate Items: Create small, detailed items like arrows, forged documents, or jewelry.
  - Indulge Vice (Speed): Recover from stress by engaging in high-stakes gambling, pursuing luxury, or frequenting exclusive social circles.
  - Maintain Gear: Spend time cleaning, sharpening, and repairing your equipment to ensure it functions at peak performance.
...
- `Blue`
  ...
  - Leverage Systems: Manage the economy of a holding, establish a trade route, or use financial debt to exert influence.
  - Long-Term Projects: Training an apprentice, composing a song or poem, or running a long-term experiment.
  - Maintain Purpose: Actively struggling to maintain one's sense of self and fighting off despair after trauma or repeated failure.
  - Resist Mental Intrusion: Feeling the "gaze" of an enemy trying to scry your location and actively resisting it over time.
  - Sacrifice Sanity: Willingly risk your mind by reading a forbidden text or gazing at a maddening creature in exchange for critical knowledge.
  - Secure a Political Marriage: Negotiating a marriage alliance to secure power, land, or a strategic advantage.
  - Strategic Sorcery: Using magic for a large-scale, strategic military purpose, like creating fog to cover an advance.
  - Strategically Deceive: Use a magical viewing device to show a false image to an enemy.
  - Study a Target: Spend downtime researching a specific faction or individual to learn their habits, connections, and weaknesses in preparation for future manipulation.
  - Use Alchemy: Using alchemy to identify substances or create concoctions.
  - Write or compose a treatise, poem or song especially if it has intricate structure, clever wordplay,

# Document Purpose

This is a player facing document

The document (as of 2025-07-10) is mostly AI drafted with an intent of covering a lot of ground. It has had only mild oversight by Tom. Keep a critical eye on it please edit or delete things that feel inappropriate for our game.
