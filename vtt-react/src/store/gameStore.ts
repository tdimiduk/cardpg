    ...
    dispatch: (action: GameAction) =>
      set((state) => {
        switch (action.type) {
          ...
          case 'ADD_LOG': {
            state.logs.push(
              createLog(action.message, action.sender, action.logType, action.actionResult),
            );
            break;
          }
          ...
          case 'RESHUFFLE': {
            ...
            state.logs.push(
              createLog(`${actor.name} reshuffled discard pile into deck.`, 'System'),
            );
            break;
          }
          ...
          case 'ADD_STATUS': {
            ...
            state.logs.push(
              createLog(`${actor.name} added ${newCard.name} to ${label}.`, 'System'),
            );
            break;
          }
          ...
          case 'REMOVE_STATUS': {
            ...
            if (removed) {
              state.logs.push(
                createLog(`Removed ${removed.name} from ${actor.name}'s deck.`, 'System'),
              );
            } else {
              state.logs.push(
                createLog(`No ${action.statusType} cards found to remove.`, 'System'),
              );
            }
            break;
          }
          ...
          case 'CANCEL_PLAN': {
            ...
            state.logs.push(
              createLog(`${actor?.name || 'Unknown'} is revising their plan.`, 'System'),
            );
            break;
          }
          ...
          case 'PLAY_IMMEDIATE': {
            ...
            // Log
            const strength = calculateStackStrength(
              action.cards,
            ...
            state.logs.push(
              createLog(
                action.actionName
                  ? `${actor.name} used ${action.actionName} (${cardNames})`
                ...
                'action',
                {
                  ...
                  targetColor: action.targetDefense,
                  label: 'Strength',
                },
              ),
            );
