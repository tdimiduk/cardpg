...
describe('Actor Slice Hydration', () => {
    it('hydrates equipped items correctly from valid server state', () => {
        ...
        const serverState = {
            ...
            actorType: 'PC',
            coreState: {
                deck: [], hand: [], discard: [], defending: [], inPlay: {}, registry: {}
            },
            tableState: {
                assets: {
        ...
        const serverState = {
            ...
            tableState: {
                ...
                registry: {
                    [cardId1]: {
                        type: 'tCItem',
                        data: { type: 'itemCard', name: 'Stashed Sword', stats: { red: 0, yellow: 0, blue: 0 } }
                    },
                    [cardId2]: {
                        type: 'tCItem',
                        data: { type: 'itemCard', name: 'Equipped Sword', stats: { red: 0, yellow: 0, blue: 0 } }
                    },
                    [cardId3]: {
                        type: 'tCNature',
